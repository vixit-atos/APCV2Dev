({
    doInit: function(component, event, helper) {
        ...
        {
            //$A.util.removeClass(component.find("spinner3"), "slds-hide");  
            ...
            ListColumnSrvc.getListColumn(component.get("v.Static_resource_list"), function(result) {
                ...
                ListDataSrvc.getListData(component.get("v.Stagefilter") , component.get("v.Statusfilter"), component.get("v.domain") ,
                                         component.get("v.source") , component.get("v.methodname"), function(result) {
                                             //$A.util.addClass(component.find("spinner3"), "slds-hide");  
            ...
            ListColumnSrvc.getListColumn(component.get("v.Static_resource_list"), function(result) 
                                         {
                                             ...
                                             component.set("v.FieldNames",fieldNames);
                                             var ListDataSrvc = component.find("ListDataservice");  
                                             console.log('Sold To Party: ' + component.get("v.soldToParty"));
                                             ListDataSrvc.getAllDataExistingOrder(component.get("v.requestNumber") , component.get("v.requestType"), component.get("v.APC_Source") ,
                                                                                  component.get("v.soldToParty") , component.get("v.methodname"), true,  function(result) 
                                                                                  {
                                                                                      debugger;
                ...
                ListColumnSrvc.getListColumn(component.get("v.Static_resource_list"), function(result) {
                    ...
                    ListDataSrvc.getAllDataExistingOrder(component.get("v.requestNumber") , component.get("v.requestType"), component.get("v.APC_Source") ,
                                                         component.get("v.soldToParty") , "getReceivedOrderFromParagon",true,
                                                         function(result) 
                                                         {       debugger;                                                      
                                                             component.set("v.IsSpinner", false);
                                                             let returnMap = result;
                                                             ...
                                                             if(OrderType.includes(itemheader.SalesOrderType+suffixvalue))
                                                             {
                                                                 ...
                                                                 if(typeof(returnMap.cases) != "undefined")
                                                                 {
                                                                     ...
                                                                     cases.forEach(function(cs){
                                                                         ...
                                                                         /* if(cs.Credit_Debit__c){
                                                                          casescreditdebitmap[cs.Credit_Debit__c] = cs;
                                                                      }*/
                                                                     });
                                                                 ...
                                                                 if(SalesOrderResponse.ReturnCode==="00")
                                                                 {
                                                                     ...
                                                                     itemsArray.forEach(function(elem){
                                                                         ...
                                                                         if(typeof(returnMap.cases) != "undefined"){
                                                                             ...
                                                                             //elem.case = casesMap.hasOwnProperty(elem.OrderLineNumber) ? casesMap[elem.OrderLineNumber] : casesmaterialmap.hasOwnProperty(elem.Material) ? casesmaterialmap[elem.Material] : casescreditdebitmap.hasOwnProperty(itemheader.SalesOrderNumber) ? casescreditdebitmap[itemheader.SalesOrderNumber] : null;
                                                                             //elem.case = casesmaterialmap.hasOwnProperty(elem.Material) ? casesmaterialmap[elem.Material] : null;
                                                                         }else
                                                                         {
                                                                             elem.case = null;
                                                                         }
    ...
    rowselectedaction: function(component, event, helper){
        ...
        }else
        {
            ...
            //helper.Paging(component,component.get("v.cases"),0,component.get("v.pagesize")); change to check if the list is not refreshed
        }
